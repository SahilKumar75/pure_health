...
def main():
    ...
    df_general.to_csv('water_quality_data.csv', index=False)
    ...
    df_urban.to_csv('water_quality_urban_polluted.csv', index=False)
    ...
    df_monsoon.to_csv('water_quality_monsoon.csv', index=False)
    ...
    df_summer.to_csv('water_quality_summer.csv', index=False)
    ...
    df_winter.to_csv('water_quality_winter.csv', index=False)
    ...
    df_all_seasons.to_csv('water_quality_all_seasons.csv', index=False)
